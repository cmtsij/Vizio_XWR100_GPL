...
static int __init init(void)
{
	...
	char *p;
        ...
        u_int32_t q931_port = Q931_PORT << 16;
	u_int32_t ras_port = RAS_PORT << 16;
	ip_conntrack_helper_q931.tuple.src.u.all = q931_port;
	ip_conntrack_helper_ras.tuple.src.u.all = ras_port;
