...
// Gemtek +++ 20090923 ---
// 1. We just make this value dynamic
// 2. For KiSS 1600 player, viewing photos will make itself crashed
// 3. So we set DHS_READ_BLOCK_SIZE to 100 ; this only affect players who do not indicate 
// 	its transfer mode (Interactive) when viewing photos
//#define DHS_READ_BLOCK_SIZE 16384
int DHS_READ_BLOCK_SIZE;
