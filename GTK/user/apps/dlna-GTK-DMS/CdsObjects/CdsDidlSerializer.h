...
/*   Provides an enumeration of the properties that can be used for sorting and searching.
 
	Applications usually set fields on an unsigned int and call
	CDS_ConvertBitStringToCsvString() to convert a set
	...
	DMS implementation should consider for indexing in a relational database.
 	...
 	The specified values in this list MUST correspond with values in CdsFilterBits.
 */
enum CdsSortableSearchableFields
{
	/* Include  dc:title  in the set of properties. */
	CdsSearchSort_Title			= 0x00000001,

	/* Include  dc:creator  in the set of properties. */
	CdsSearchSort_Creator		= 0x00000002,

	/*  Include  upnp:class in the set of properties. */
	CdsSearchSort_Class			= 0x00000004,

	/*  Include  upnp:album  in the set of properties. */
	CdsSearchSort_Album			= 0x00000400,

	/*  Include  upnp:genre  in the set of properties. */
