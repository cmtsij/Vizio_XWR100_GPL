...
*/
// Gemtek +++ 20091209 --- for XBOX 360, image needs to be: object.item.imageItem.photo
//#define CDS_MEDIACLASS_IMAGEITEM				(CDS_CLASS_MASK_ITEM | CDS_CLASS_MASK_MAJOR_IMAGEITEM			)
#define CDS_MEDIACLASS_IMAGEITEM				(CDS_CLASS_MASK_ITEM | CDS_CLASS_MASK_MAJOR_IMAGEITEM | CDS_CLASS_MASK_MINOR1_PHOTO			)
