...
#include "../include/netfilter_ipv4/ipt_layer7.h"
...
int parse_protocol_file(char * filename, const char * protoname, struct ipt_layer7_info *info)
{
	FILE * f;
	char * line = NULL;
	size_t len = 0;
...
static void
parse_layer7_protocol(const char *s, struct ipt_layer7_info *info)
{
