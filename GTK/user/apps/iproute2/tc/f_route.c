...
{
	my_printf("Usage: ... route [ from REALM | fromif TAG ] [ to REALM ]\n");
	my_printf("                [ flowid CLASSID ] [ police POLICE_SPEC ]\n");
	my_printf("       POLICE_SPEC := ... look at TBF\n");
	my_printf("       CLASSID := X:Y\n");
}
