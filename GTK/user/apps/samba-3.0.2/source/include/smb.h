...
/* qos relevant defines and types
 */
typedef enum
{
	QOS_DATA_FILE,
...
#define TOS_DATA_TRAFFIC    0x00
#define TOS_AUDIO_TRAFFIC   0x68
#define TOS_VIDEO_TRAFFIC   0x88
#define MAX_FILE_EXT_LEN    10
#define MAX_FILE_TYPES      10
#define DATA_PROC_PRIORITY  20
#define AUDIO_PROC_PRIORITY 40
#define VIDEO_PROC_PRIORITY 80
...
typedef struct connection_struct
{
	...
	/* This group of info is used for file extension based QoS
	 */
    int num_video_files_open;
	int num_audio_files_open;
	qos_priority_enum current_qos_priority;
