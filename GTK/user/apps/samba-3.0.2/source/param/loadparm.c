...
typedef struct
{
	...
	/* Added for file extension based QoS
 	 */
	BOOL bQosEnable;
	char *szVideoFileExtensions;
	char *szAudioFileExtensions;
}
global;
...
static struct parm_struct parm_table[] = {
    ...
    /* QoS section */
	{"qos enable", P_BOOL, P_GLOBAL, &Globals.bQosEnable, NULL, NULL, FLAG_BASIC | FLAG_WIZARD},
    {"video file extensions", P_STRING, P_GLOBAL, &Globals.szVideoFileExtensions, NULL, NULL, 0},
    {"audio file extensions", P_STRING, P_GLOBAL, &Globals.szAudioFileExtensions, NULL, NULL, 0},
...
*/
	...
	/* init QoS relevant data
 	 */
	Globals.bQosEnable = False;
	string_set(&Globals.szVideoFileExtensions, DEFAULT_VIDEO_FILE_EXTS);
	string_set(&Globals.szAudioFileExtensions, DEFAULT_AUDIO_FILE_EXTS);
...
FN_GLOBAL_BOOL(lp_qos_enable, &Globals.bQosEnable)
FN_GLOBAL_STRING(lp_video_file_extension, &Globals.szVideoFileExtensions)
FN_GLOBAL_STRING(lp_audio_file_extension, &Globals.szAudioFileExtensions)
